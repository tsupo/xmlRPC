...
# ADD CPP /nologo /MDd /W4 /GX /Zi /Od /I "..\..\openssl-0.9.8k\inc32" /I "..\..\libiconv-1.13.1\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "XMLRPC_EXPORTS" /D "SUPPORT_FOR_WIN95" /D "USE_APIS" /FR /FD /GZ /c
# SUBTRACT CPP /u /YX
...
# ADD LINK32 libeay32d.lib ssleay32d.lib iconv.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /version:1.277 /dll /incremental:no /map /debug /machine:I386 /out:"Debug/xmlRPC.dll" /pdbtype:sept /libpath:"..\..\openssl-0.9.8k\out32_debug" /libpath:"..\..\libiconv-1.13.1\windows\Debug" /libpath:"misc"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Desc=copy dll
